...
\todo{Add explanation for szegedy et al method here}
...
\todo{expand on these explanations in a more rigrous way, perhaps with some diagrams}
\section{Methods}
...
\todo{craig can expand on his experimental methods here}
%------------------------------------------------
